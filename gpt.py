...
class Head(nn.Module):
    ...
    def forward(self, x):
        ...
        # computer attention scores ('affinites')
...
class FeedForward(nn.Module):
    ...
    def __init__(self, n_embd):
        ...
        self.net = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(4*n_embd, n_embd), # proj layer, needed to ensure residual match dimensions
            nn.Dropout(dropout),
        )
...
class Block(nn.Module):
    ...
    def forward(self, x):
        ...
        # use pre-layer norm instead, since this is the new standard
...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        tok_emb = self.token_embedding_table(idx) # (B,T,C) batch x time x channels
    ...
    def generate(self, idx, max_new_tokens):
        # idx is (B, T) accuracy of indices in the current context
